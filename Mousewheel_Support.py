...
class Scrolling_Area(Frame, object):
    ...
    def __init__(self, master, width=None, anchor=N, height=None, mousewheel_speed=2, scroll_horizontally=True,
                 xscrollbar=None, scroll_vertically=True, yscrollbar=None, background=None, bd=None, relief=None,
                 inner_frame=Frame, **kw):
        Frame.__init__(self, master, class_="Scrolling_Area", background=background, bd=bd, relief=relief)
        ...
        self.innerframe.place(anchor=anchor)
    ...
    def update_viewport(self, y="Top"):
        self.update()
